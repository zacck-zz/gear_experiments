...
r2   = 0xbe92b31c, r3   = 0x00000002
r4   = 0xfbad8001, r5   = 0xbe92b200
r6   = 0xbe92b31c, r7   = 0x405ac000
r8   = 0x00000000, r9   = 0x000010dc
r10  = 0x00000002, fp   = 0xbe92b1f4
ip   = 0x405ab9c8, sp   = 0xbe92ac78
...
be90b000 be92c000 rw-p [stack]
End of Maps Information

Callstack Information (PID:4316)
Call Stack Count: 1
...
moment_bar.c: windicator_moment_bar_hide_directly(548) > [windicator_moment_bar_hide_directly:548] windicator_moment_bar_hide_directly
09-09 11:46:26.810+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __is_cached_cookie(230) > Find cached cookie for [964].
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: OnReadMessage(739) > _MessagePortIpcServer::OnReadMessage
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: HandleReceivedMessage(578) > _MessagePortIpcServer::HandleReceivedMessage
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortStub.cpp: OnIpcRequestReceived(147) > MessagePort message received
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortStub.cpp: OnCheckRemotePort(115) > _MessagePortStub::OnCheckRemotePort.
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: CheckRemotePort(200) > _MessagePortService::CheckRemotePort
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: GetKey(358) > _MessagePortService::GetKey
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: CheckRemotePort(213) > Check a remote message port: [com.samsung.w-music-player.music-control-service:music-control-service-request-message-port]
09-09 11:46:26.825+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: Send(847) > _MessagePortIpcServer::Stop
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: OnReadMessage(739) > _MessagePortIpcServer::OnReadMessage
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: HandleReceivedMessage(578) > _MessagePortIpcServer::HandleReceivedMessage
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortStub.cpp: OnIpcRequestReceived(147) > MessagePort message received
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortStub.cpp: OnSendMessage(126) > MessagePort OnSendMessage
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: SendMessage(284) > _MessagePortService::SendMessage
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: GetKey(358) > _MessagePortService::GetKey
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: SendMessage(292) > Sends a message to a remote message port [com.samsung.w-music-player.music-control-service:music-control-service-request-message-port]
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortStub.cpp: SendMessage(138) > MessagePort SendMessage
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: SendResponse(884) > _MessagePortIpcServer::SendResponse
09-09 11:46:26.835+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: Send(847) > _MessagePortIpcServer::Stop
09-09 11:46:26.840+0200 I/APP_CORE( 1088): appcore-efl.c: __do_app(453) > [APP 1088] Event: PAUSE State: RUNNING
09-09 11:46:26.840+0200 I/CAPI_APPFW_APPLICATION( 1088): app_main.c: app_appcore_pause(202) > app_appcore_pause
09-09 11:46:26.840+0200 W/W_HOME  ( 1088): main.c: _appcore_pause_cb(489) > appcore pause
09-09 11:46:26.840+0200 E/W_HOME  ( 1088): main.c: _pause_cb(467) > paused already
09-09 11:46:26.860+0200 W/MUSIC_CONTROL_SERVICE( 1500): music-control-service.c: _music_control_service_pasre_request(565) > [33m[TID:1500]   [com.samsung.w-home]register msg port [false][0m
09-09 11:46:26.880+0200 W/APPS    ( 1088): AppsViewNecklace.cpp: onPausedIdlerCb(5178) >  elm_cache_all_flush
09-09 11:46:26.895+0200 E/ALARM_MANAGER(  524): alarm-manager-schedule.c: _alarm_next_duetime(509) > alarm_id: 1746865882, next duetime: 1536486407
09-09 11:46:26.895+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __alarm_add_to_list(496) > [alarm-server]: After add alarm_id(1746865882)
09-09 11:46:26.895+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __alarm_create(1061) > [alarm-server]:alarm_context.c_due_time(1536487199), due_time(1536486407)
09-09 11:46:26.900+0200 W/SHealthCommon( 1374): SystemUtil.cpp: OnDeviceStatusChanged(1007) > [1;35mlcdState:3[0;m
09-09 11:46:26.900+0200 W/SHealthServiceCommon( 1374): SHealthServiceController.cpp: OnSystemUtilLcdStateChanged(645) > [1;35m ###[0;m
09-09 11:46:26.905+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __display_lock_state(1884) > Lock LCD OFF is successfully done
09-09 11:46:26.905+0200 W/WAKEUP-SERVICE( 1291): WakeupService.cpp: OnReceiveDisplayChanged(979) > [0;32mINFO: LCDOff receive data : 1075006220[0;m
09-09 11:46:26.905+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __rtc_set(325) > [alarm-server]ALARM_CLEAR ioctl is successfully done.
09-09 11:46:26.905+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __rtc_set(332) > Setted RTC Alarm date/time is 9-9-2018, 09:46:47 (UTC).
09-09 11:46:26.905+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __rtc_set(347) > [alarm-server]RTC ALARM_SET ioctl is successfully done.
09-09 11:46:26.905+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __save_module_log(1780) > The file is not ready.
09-09 11:46:26.915+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __display_unlock_state(1927) > Unlock LCD OFF is successfully done
09-09 11:46:26.920+0200 W/WAKEUP-SERVICE( 1291): WakeupService.cpp: OnReceiveDisplayChanged(980) > [0;32mINFO: WakeupServiceStop[0;m
09-09 11:46:26.920+0200 W/WAKEUP-SERVICE( 1291): WakeupService.cpp: WakeupServiceStop(399) > [0;32mINFO: SEAMLESS WAKEUP STOP REQUEST[0;m
09-09 11:46:26.920+0200 E/ALARM_MANAGER(  524): alarm-manager.c: __save_module_log(1780) > The file is not ready.
09-09 11:46:26.925+0200 E/WAKEUP-SERVICE( 1291): WakeupService.cpp: _WakeupIsAvailable(288) > [0;31mERROR: db/private/com.samsung.wfmw/is_locked FAILED[0;m
09-09 11:46:26.925+0200 E/WAKEUP-SERVICE( 1291): WakeupService.cpp: _WakeupIsAvailable(314) > [0;31mERROR: file/calendar/alarm_state FAILED[0;m
09-09 11:46:26.925+0200 I/TIZEN_N_SOUND_MANAGER( 1291): sound_manager_product.c: sound_manager_svoice_wakeup_enable(1255) > [SVOICE] Wake up Disable start
09-09 11:46:26.930+0200 I/TIZEN_N_SOUND_MANAGER( 1291): sound_manager_product.c: sound_manager_svoice_wakeup_enable(1258) > [SVOICE] Wake up Disable end. (ret: 0x0)
09-09 11:46:26.930+0200 W/TIZEN_N_SOUND_MANAGER( 1291): sound_manager_private.c: __convert_sound_manager_error_code(156) > [sound_manager_svoice_wakeup_enable] ERROR_NONE (0x00000000)
09-09 11:46:26.930+0200 W/WAKEUP-SERVICE( 1291): WakeupService.cpp: WakeupSetSeamlessValue(360) > [0;32mINFO: WAKEUP SET : 0[0;m
09-09 11:46:26.930+0200 I/HIGEAR  ( 1291): WakeupService.cpp: WakeupServiceStop(403) > [svoice:Application:WakeupServiceStop:IN]
09-09 11:46:27.345+0200 I/APP_CORE( 1088): appcore-efl.c: __do_app(453) > [APP 1088] Event: MEM_FLUSH State: PAUSED
09-09 11:46:31.940+0200 I/APP_CORE( 1088): appcore-efl.c: __do_app(453) > [APP 1088] Event: MEM_FLUSH State: PAUSED
09-09 11:46:44.925+0200 W/W_INDICATOR( 1003): windicator_util.c: _pm_state_changed_cb(915) > [_pm_state_changed_cb:915] LCD on
09-09 11:46:44.925+0200 W/W_INDICATOR( 1003): windicator_ongoing_info_shealth.c: windicator_ongoing_info_shealth_update(57) > [windicator_ongoing_info_shealth_update:57] windicator_shealth_update
09-09 11:46:44.925+0200 W/SHealthCommon( 1272): SystemUtil.cpp: OnDeviceStatusChanged(1007) > [1;35mlcdState:1[0;m
09-09 11:46:44.940+0200 I/HealthDataService( 1127): RequestHandler.cpp: OnHealthIpcMessageSync(123) > [1;35mServer Received: SHARE_GET[0;m
09-09 11:46:44.985+0200 W/WATCH_CORE( 1151): appcore-watch.c: __signal_lcd_status_handler(1231) > signal_lcd_status_signal: LCDOn
09-09 11:46:44.985+0200 I/WATCH_CORE( 1151): appcore-watch.c: __signal_lcd_status_handler(1250) > Call the time_tick_cb
09-09 11:46:44.990+0200 I/CAPI_WATCH_APPLICATION( 1151): watch_app_main.c: _watch_core_time_tick(313) > _watch_core_time_tick
09-09 11:46:44.990+0200 E/watchface-loader( 1151): watchface-loader.cpp: OnAppTimeTick(812) > 
09-09 11:46:44.990+0200 I/watchface-loader( 1151): watchface-loader.cpp: OnAppTimeTick(823) > set force update!!
09-09 11:46:44.990+0200 I/WATCH_CORE( 1151): appcore-watch.c: __signal_lcd_status_handler(1257) > Call widget_provider_update_event
09-09 11:46:44.995+0200 I/watchface-viewer( 1151): viewer-image-file-loader.cpp: OnImageLoadingDoneIdlerCb(792) > ImagesLoadingDoneSignal().Emit()
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): dbus.c: _dbus_message_recv_cb(186) > LCD on
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): gesture.c: _manual_render_disable_timer_set(167) > timer set
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): gesture.c: _manual_render_disable_timer_del(157) > timer del
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): gesture.c: _apps_status_get(128) > apps status:0
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): gesture.c: _lcd_on_cb(303) > move_to_clock:0 clock_visible:1 info->offtime:18407
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): gesture.c: _manual_render_schedule(209) > schedule, manual render
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): event_manager.c: _lcd_on_cb(715) > lcd state: 1
09-09 11:46:44.995+0200 W/W_HOME  ( 1088): event_manager.c: _state_control(176) > control:4, app_state:2 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
09-09 11:46:44.995+0200 W/STARTER (  964): clock-mgr.c: _on_lcd_signal_receive_cb(1258) > [_on_lcd_signal_receive_cb:1258] _on_lcd_signal_receive_cb, 1258, Pre LCD on by [unknown] after screen off time [18407]ms
09-09 11:46:44.995+0200 W/STARTER (  964): clock-mgr.c: _pre_lcd_on(1027) > [_pre_lcd_on:1027] Will LCD ON as reserved app[(null)] alpm mode[0]
09-09 11:46:45.010+0200 I/APP_CORE( 1088): appcore-efl.c: __do_app(453) > [APP 1088] Event: RESUME State: PAUSED
09-09 11:46:45.010+0200 I/CAPI_APPFW_APPLICATION( 1088): app_main.c: app_appcore_resume(223) > app_appcore_resume
09-09 11:46:45.010+0200 W/W_HOME  ( 1088): main.c: _appcore_resume_cb(480) > appcore resume
09-09 11:46:45.010+0200 W/W_HOME  ( 1088): event_manager.c: _app_resume_cb(373) > state: 2 -> 1
09-09 11:46:45.010+0200 W/W_HOME  ( 1088): event_manager.c: _state_control(176) > control:2, app_state:1 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
09-09 11:46:45.010+0200 W/W_HOME  ( 1088): event_manager.c: _state_control(176) > control:0, app_state:1 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
09-09 11:46:45.010+0200 W/W_HOME  ( 1088): event_manager.c: _state_control(176) > control:1, app_state:1 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
09-09 11:46:45.010+0200 W/APPS    ( 1088): apps_main.c: _time_changed_cb(409) >  date : 9->9
09-09 11:46:45.010+0200 W/APPS    ( 1088): AppsViewNecklace.cpp: setBubbleColor(2479) >  [249, 249, 249, 255]
09-09 11:46:45.010+0200 W/W_HOME  ( 1088): rotary.c: rotary_attach(138) > rotary_attach:0x47c25398
09-09 11:46:45.010+0200 I/efl-extension( 1088): efl_extension_rotary.c: eext_rotary_object_event_activated_set(283) > eext_rotary_object_event_activated_set : 0x47c25398, elm_layout, _activated_obj : 0x4607c708, activated : 1
09-09 11:46:45.010+0200 I/efl-extension( 1088): efl_extension_rotary.c: eext_rotary_object_event_activated_set(291) > Activation delete!!!!
...
09-09 11:46:46.340+0200 W/CRASH_MANAGER( 4229): worker.c: worker_job(1205) > 1104316776174153648640
