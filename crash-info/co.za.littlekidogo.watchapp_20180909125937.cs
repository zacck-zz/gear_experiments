...
r4   = 0x00000000, r5   = 0xbecc2dc8
r6   = 0x413c0771, r7   = 0x00000004
r8   = 0x00000029, r9   = 0x00000000
r10  = 0x413c075c, fp   = 0xbecc2dbc
ip   = 0xbecc330c, sp   = 0xbecc2850
...
41620000 4162b000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
41636000 41657000 r-xp /usr/lib/libefl-extension.so.0.1.0
4165f000 41671000 r-xp /usr/lib/libefl-assist.so.0.1.0
41679000 416ff000 rw-p [heap]
41893000 4194b000 r-xp /usr/lib/libcairo.so.2.11200.14
41956000 4196c000 r-xp /usr/lib/libtts.so
41975000 41998000 r-xp /usr/lib/libui-extension.so.0.1.0
419a1000 419ac000 r-xp /usr/lib/libtbm.so.1.0.0
419b4000 419c2000 r-xp /usr/lib/libGLESv2.so.2.0
419cb000 419cc000 r-xp /usr/lib/libxcb-shm.so.0.0.0
419d5000 419db000 r-xp /usr/lib/libxcb-render.so.0.0.0
419e3000 419e6000 r-xp /usr/lib/libEGL.so.1.4
419ee000 419f3000 r-xp /usr/lib/libcapi-system-info.so.0.2.0
419fb000 419fe000 r-xp /usr/lib/libcapi-media-image-util.so.0.3.5
41a06000 41a07000 r-xp /usr/lib/libsecurity-privilege-checker.so.1.0.1
41a10000 41b98000 r-xp /usr/lib/libicui18n.so.57.1
41ba8000 41cae000 r-xp /usr/lib/libicuuc.so.57.1
41cc4000 41ccc000 r-xp /usr/lib/libdrm.so.2.4.0
41cd4000 41cd6000 r-xp /usr/lib/libdri2.so.0.0.0
41cde000 41ce4000 r-xp /usr/lib/libmmutil_jpeg.so.0.0.0
41cec000 41cf1000 r-xp /usr/lib/libmmutil_imgp.so.0.0.0
41cf9000 41d12000 r-xp /usr/lib/libprivacy-manager-client.so.0.0.8
435b3000 435d4000 r-xp /usr/lib/libexif.so.12.3.3
435e7000 435e9000 r-xp /usr/lib/libttrace.so.1.1
435f1000 435f6000 r-xp /usr/lib/libcapi-media-tool.so.0.1.5
435fe000 43604000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.2.8
4360d000 43615000 r-xp /usr/lib/libcapi-appfw-package-manager.so.0.0.59
4361d000 4363f000 r-xp /usr/lib/libpkgmgr-client.so.0.1.68
43648000 4364f000 r-xp /usr/lib/libpkgmgr_installer_client.so.0.1.0
43658000 4365a000 r-xp /usr/lib/libpkgmgr_installer_status_broadcast_server.so.0.1.0
43662000 43669000 r-xp /usr/lib/libminizip.so.1.0.0
43671000 4367e000 r-xp /usr/lib/libail.so.0.1.0
43687000 4368d000 r-xp /usr/lib/libproc-stat.so.0.2.96
43695000 43696000 r-xp /usr/lib/libresponse.so.0.2.96
...
R (  964): hw_key.c: _key_press_cb(1477) > [_key_press_cb:1477] POWER Key is pressed
...
09-09 12:59:31.583+0200 W/CRASH_MANAGER(14182): worker.c: worker_job(1205) > 11143547761741536490771
09-09 12:59:32.333+0200 W/AUL_PAD ( 1235): sigchild.h: __launchpad_process_sigchld(188) > dead_pid = 14354 pgid = 14354
09-09 12:59:32.333+0200 W/AUL_PAD ( 1235): sigchild.h: __launchpad_process_sigchld(189) > ssi_code = 2 ssi_status = 11
09-09 12:59:32.353+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __read_proc(55) > file open error : 2
09-09 12:59:32.353+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __get_proc_bypid(85) > ERR: __get_proc_bypid : -2
09-09 12:59:32.358+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __status_get_proc_bypid(142) > No file exist : pid(14354), proc(0)
09-09 12:59:32.363+0200 E/AUL     ( 1272): pkginfo.c: __get_id_bypid(213) > Failed to get the cmdline of pid, error: -2
09-09 12:59:32.363+0200 E/CAPI_APPFW_APP_MANAGER( 1272): app_manager.c: app_manager_error(77) > [app_context_get_app_context_by_pid] No such application(0xfeef0001)
09-09 12:59:32.363+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __security_extension_process_handler(179) > Error: fail to status get proc by pid
09-09 12:59:32.378+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __read_proc(55) > file open error : 2
09-09 12:59:32.378+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __get_proc_bypid(85) > ERR: __get_proc_bypid : -2
09-09 12:59:32.383+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __status_get_proc_bypid(142) > No file exist : pid(14354), proc(0)
09-09 12:59:32.383+0200 E/SECURITY_EXTENSION_SERVER(  508): security_extension_system.c: __security_extension_process_handler(179) > Error: fail to status get proc by pid
09-09 12:59:32.393+0200 W/AUL_PAD ( 1235): sigchild.h: __launchpad_process_sigchld(197) > after __sigchild_action
09-09 12:59:32.398+0200 E/AUL     ( 1374): pkginfo.c: __get_id_bypid(213) > Failed to get the cmdline of pid, error: -2
09-09 12:59:32.398+0200 I/AUL_AMD (  509): amd_main.c: __app_dead_handler(262) > __app_dead_handler, pid: 14354
09-09 12:59:32.398+0200 W/AUL     (  509): app_signal.c: aul_send_app_terminated_signal(799) > aul_send_app_terminated_signal pid(14354)
09-09 12:59:32.428+0200 E/CAPI_APPFW_APP_MANAGER( 1374): app_manager.c: app_manager_error(77) > [app_context_get_app_context_by_pid] No such application(0xfeef0001)
09-09 12:59:34.483+0200 I/AUL_PAD (14374): launchpad_loader.c: main(591) > [candidate] elm init, returned: 1
09-09 12:59:37.438+0200 E/EFL     ( 1088): ecore_x<1088> ecore_x_events.c:563 _ecore_x_event_handle_button_press() ButtonEvent:press time=6585571 button=1
09-09 12:59:37.438+0200 W/W_HOME  ( 1088): event_manager.c: home_event_manager_allowance_get(860) > editing:0 clocklist_state:0 addviewer:0 scrolling:0 apptray-state:0 apptray-visibility:1 apptray-edit_visibility:0
09-09 12:59:37.438+0200 W/W_HOME  ( 1088): event_manager.c: home_event_manager_allowance_get(860) > editing:0 clocklist_state:0 addviewer:0 scrolling:0 apptray-state:0 apptray-visibility:1 apptray-edit_visibility:0
09-09 12:59:37.438+0200 W/APPS    ( 1088): AppsViewNecklace.cpp: touchPressed(1663) >  TOUCH [171, 192]
09-09 12:59:37.443+0200 W/APPS    ( 1088): AppsViewNecklace.cpp: onBubbleButtonEffect(2428) >  [249, 249, 249, 102]
09-09 12:59:37.443+0200 E/EFL     ( 1088): evas_main<1088> evas_object_main.c:1440 evas_object_color_set() Evas only handles pre multiplied colors!
09-09 12:59:37.443+0200 E/EFL     ( 1088): evas_main<1088> evas_object_main.c:1445 evas_object_color_set() Evas only handles pre multiplied colors!
09-09 12:59:37.443+0200 E/EFL     ( 1088): evas_main<1088> evas_object_main.c:1450 evas_object_color_set() Evas only handles pre multiplied colors!
09-09 12:59:37.443+0200 E/W_HOME  ( 1088): util.c: util_is_rdu_retailmode(1530) > Cannot get the vconf for retailmode
09-09 12:59:37.458+0200 W/W_HOME  ( 1088): event_manager.c: home_event_manager_allowance_get(860) > editing:0 clocklist_state:0 addviewer:0 scrolling:0 apptray-state:0 apptray-visibility:1 apptray-edit_visibility:0
09-09 12:59:37.458+0200 W/W_HOME  ( 1088): event_manager.c: home_event_manager_allowance_get(860) > editing:0 clocklist_state:0 addviewer:0 scrolling:0 apptray-state:0 apptray-visibility:1 apptray-edit_visibility:0
09-09 12:59:37.533+0200 W/W_HOME  ( 1088): event_manager.c: home_event_manager_allowance_get(860) > editing:0 clocklist_state:0 addviewer:0 scrolling:0 apptray-state:0 apptray-visibility:1 apptray-edit_visibility:0
09-09 12:59:37.553+0200 E/EFL     ( 1088): ecore_x<1088> ecore_x_events.c:722 _ecore_x_event_handle_button_release() ButtonEvent:release time=6585679 button=1
09-09 12:59:37.553+0200 W/APPS    ( 1088): AppsViewNecklace.cpp: touchReleased(1976) >  TOUCH [171, 192]->[176, 187]
09-09 12:59:37.558+0200 W/APPS    ( 1088): AppsViewNecklace.cpp: onBubbleButtonEffect(2446) >  [249, 249, 249, 255]
09-09 12:59:37.558+0200 W/APPS    ( 1088): AppsItem.cpp: onItemClicked(478) >  onItemClicked[0,14]
09-09 12:59:37.558+0200 E/APPS    ( 1088): effect.c: apps_effect_play_sound(86) >  effect_info.sound_status: [0]
09-09 12:59:37.558+0200 W/APPS    ( 1088): AppsItem.cpp: onItemClicked(502) >  item(watchapp) launched, open(0), tts(0)
09-09 12:59:37.558+0200 W/AUL     ( 1088): launch.c: app_request_to_launchpad(284) > request cmd(0) to(co.za.littlekidogo.watchapp)
09-09 12:59:37.558+0200 W/AUL_AMD (  509): amd_request.c: __request_handler(669) > __request_handler: 0
09-09 12:59:37.563+0200 W/AUL_AMD (  509): amd_launch.c: _start_app(1782) > caller pid : 1088
09-09 12:59:37.563+0200 I/AUL_AMD (  509): amd_launch.c: __check_app_control_privilege(1693) > Skip the privilege check in case of preloaded apps
09-09 12:59:37.583+0200 W/AUL_AMD (  509): amd_launch.c: _start_app(2218) > pad pid(-5)
09-09 12:59:37.583+0200 W/AUL_PAD ( 1235): launchpad.c: __launchpad_main_loop(611) > Launch on type-based process-pool
09-09 12:59:37.583+0200 W/AUL_PAD ( 1235): launchpad.c: __send_result_to_caller(272) > Check app launching
09-09 12:59:37.588+0200 W/AUL_PAD (14374): launchpad_loader.c: __candidate_process_prepare_exec(259) > [candidate] before __set_access
09-09 12:59:37.588+0200 W/AUL_PAD (14374): launchpad_loader.c: __candidate_process_prepare_exec(264) > [candidate] after __set_access
09-09 12:59:37.588+0200 W/AUL_PAD (14374): launchpad_loader.c: __candidate_process_launchpad_main_loop(414) > update argument
09-09 12:59:37.588+0200 W/AUL_PAD (14374): launchpad_loader.c: main(680) > [candidate] dlopen(co.za.littlekidogo.watchapp)
09-09 12:59:37.593+0200 E/RESOURCED(  681): block.c: block_prelaunch_state(138) > insert data co.za.littlekidogo.watchapp, table num : 3
09-09 12:59:37.633+0200 I/efl-extension(14374): efl_extension.c: eext_mod_init(40) > Init
09-09 12:59:37.638+0200 I/UXT     (14374): Uxt_ObjectManager.cpp: OnInitialized(753) > Initialized.
09-09 12:59:37.638+0200 W/AUL_PAD (14374): launchpad_loader.c: main(690) > [candidate] dlsym
09-09 12:59:37.638+0200 W/AUL_PAD (14374): launchpad_loader.c: main(694) > [candidate] dl_main(co.za.littlekidogo.watchapp)
09-09 12:59:37.638+0200 I/CAPI_APPFW_APPLICATION(14374): app_main.c: ui_app_main(704) > app_efl_main
09-09 12:59:37.643+0200 I/CAPI_APPFW_APPLICATION(14374): app_main.c: _ui_app_appcore_create(563) > app_appcore_create
09-09 12:59:37.688+0200 W/AUL     (  509): app_signal.c: aul_send_app_launch_request_signal(521) > aul_send_app_launch_request_signal app(co.za.littlekidogo.watchapp) pid(14374) type(uiapp) bg(0)
09-09 12:59:37.688+0200 W/AUL_AMD (  509): amd_status.c: __socket_monitor_cb(1277) > (14374) was created
09-09 12:59:37.688+0200 E/AUL     (  509): app_signal.c: __app_dbus_signal_filter(97) > reject by security issue - no interface
09-09 12:59:37.688+0200 W/AUL     ( 1088): launch.c: app_request_to_launchpad(298) > request cmd(0) result(14374)
09-09 12:59:37.688+0200 W/W_HOME  ( 1088): util.c: apps_util_launch_main_operation(785) > Launch app:[watchapp] ret:[0]
09-09 12:59:37.693+0200 W/STARTER (  964): pkg-monitor.c: _app_mgr_status_cb(400) > [_app_mgr_status_cb:400] Launch request [14374]
09-09 12:59:37.693+0200 W/W_HOME  ( 1088): util.c: send_launch_appId(620) > launch appid[co.za.littlekidogo.watchapp]
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: OnReadMessage(739) > _MessagePortIpcServer::OnReadMessage
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: HandleReceivedMessage(578) > _MessagePortIpcServer::HandleReceivedMessage
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortStub.cpp: OnIpcRequestReceived(147) > MessagePort message received
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortStub.cpp: OnCheckRemotePort(115) > _MessagePortStub::OnCheckRemotePort.
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: CheckRemotePort(200) > _MessagePortService::CheckRemotePort
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: GetKey(358) > _MessagePortService::GetKey
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortService.cpp: CheckRemotePort(213) > Check a remote message port: [com.samsung.app-shortcut-widget:Apptray.Message.Launch.AppId]
09-09 12:59:37.693+0200 E/MESSAGE_PORT(  505): MessagePortService.cpp: CheckRemotePort(235) > _MessagePortService::CheckRemotePort() Failed: MESSAGEPORT_ERROR_MESSAGEPORT_NOT_FOUND
09-09 12:59:37.693+0200 I/MESSAGE_PORT(  505): MessagePortIpcServer.cpp: Send(847) > _MessagePortIpcServer::Stop
09-09 12:59:37.698+0200 E/MESSAGE_PORT( 1088): MessagePortProxy.cpp: CheckRemotePort(379) > The remote message port (Apptray.Message.Launch.AppId) is not found.
09-09 12:59:37.698+0200 E/W_HOME  ( 1088): util.c: send_launch_appId(636) > There is no remote message port
09-09 12:59:37.698+0200 W/APPS    ( 1088): AppsItem.cpp: onItemClicked(536) >  appid(co.za.littlekidogo.watchapp)  pkgid(co.za.littlekidogo.watchapp), name(watchapp)
09-09 12:59:37.768+0200 E/EFL     (14374): ecore_evas<14374> ecore_evas_extn.c:2204 ecore_evas_extn_plug_connect() Extn plug failed to connect:ipctype=0, svcname=elm_indicator_portrait, svcnum=0, svcsys=0
09-09 12:59:37.853+0200 I/watchapp(14374): watchapp.c: create_base_gui(82) > adding Do GTD Review
09-09 12:59:37.853+0200 I/watchapp(14374): watchapp.c: create_base_gui(84) > tmp Task: D
09-09 12:59:37.858+0200 I/watchapp(14374): watchapp.c: create_base_gui(82) > adding Build Watch Prototype
09-09 12:59:37.858+0200 I/watchapp(14374): watchapp.c: create_base_gui(84) > tmp Task: B
09-09 12:59:37.858+0200 I/watchapp(14374): watchapp.c: create_base_gui(82) > adding Research African Markets
09-09 12:59:37.858+0200 I/watchapp(14374): watchapp.c: create_base_gui(84) > tmp Task: R
09-09 12:59:37.858+0200 I/watchapp(14374): watchapp.c: create_base_gui(82) > adding Go to Durbanville for Lunch
09-09 12:59:37.858+0200 I/watchapp(14374): watchapp.c: create_base_gui(84) > tmp Task: G
09-09 12:59:37.928+0200 W/CRASH_MANAGER(14182): worker.c: worker_job(1205) > 1114374776174153649077
