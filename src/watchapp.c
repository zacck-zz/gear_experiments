...
create_base_gui(appdata_s *ad)
{
	...
	elm_object_text_set(ad->label, "<align=center>Get Shit Done!</align>");
	...
	const char *things[4];
	things[0] = "Do GTD Review";
	things[1] = "Build Watch Prototype";
	things[2] = "Research African Markets";
	things[3] = "Go to Durbanville for Lunch";


	for (i = 0; i <= 4; i++) {
	    char tmp[8];
	    snprintf(tmp, sizeof(tmp), "Task: %s", "name");
